...
\begin{itemize} \setlength\itemsep{-0.25em}
	\item Infrastructure and DevOps (Docker, Git, GCP)
	\item Full Web Stack
...
\begin{itemize}[noitemsep,topsep=0pt]
	\item Developing a front end school MIS solution in Vue.js
	\item Developing a RESTful API in Symfony/Doctrine
